...

{
...

  {
      ...
      newDiv.innerHTML += '<div style="text-align:left; background:#ffffff; margin-left:15px;font-weight:600;margin-top: 10px;font-size: 16px;">' +  message[spec]['name'] + '</div>';
...

      {
...

        {
...

          {
            ...
            newDiv.innerHTML += "<div style='line-height:40px; font-size: 14px;'><input style='margin-left:15px;' type='radio' name='spec_" + message[spec]['attr_id'] + "' value='" + message[spec]['values'][val_arr]['id'] + "' id='spec_value_" + message[spec]['values'][val_arr]['id'] + "' checked /><font color=#555555>" + message[spec]['values'][val_arr]['label'] + '</font> [' + message[spec]['values'][val_arr]['format_price'] + ']</font><br /></div>';
...

          {
            ...
            newDiv.innerHTML += "<div style='line-height:40px;font-size: 14px;'><input style='margin-left:15px;' type='radio' name='spec_" + message[spec]['attr_id'] + "' value='" + message[spec]['values'][val_arr]['id'] + "' id='spec_value_" + message[spec]['values'][val_arr]['id'] + "' /><font color=#555555>" + message[spec]['values'][val_arr]['label'] + '</font> [' + message[spec]['values'][val_arr]['format_price'] + ']</font><br /></div>';
